...
<body>
                                    ...
                                    <form id="subform">
                                        <div class="form-row">
                                            <div class="form-group col-sm-6">
                                                <?php
                                                $rey = "SELECT max(assetid) as asset_id FROM item_tbl LIMIT 1;   ";
                                                $jine = mysqli_query($conn, $rey);
                                                $datos = mysqli_fetch_array($jine);

                                                if ($datos['asset_id'] !== null) {
                                                    $currentAssetId = (int)$datos['asset_id'];
                                                    $newAssetId = sprintf('%03d', $currentAssetId + 1);
                                                } else {
                                                    $newAssetId = '001'; // If there are no records in the table yet
                                                }
                                                ?>
                                                <input type="text" disabled value="<?php echo $newAssetId; ?>" class="form-control" id="assetid" name="assetid" >
                                    ...
                                    <form id="subform">
                                        <div class="form-row">
                                            <div class="form-group col-md-12">
                                                ...
                                                <input type="text" class="form-control" name="assetname" placeholder="Item Name">
                                            </div>
                                            <div class="form-group col-md-6">
                                                <label>Company</label>
                                                <select id="company" name="companyid" class="form-control default-select">
                                                    <option value="default" selected>Select Company</option>
    ...
    ***********************************-->
    ...
    <script>
        const inputElement1 = document.querySelector('#files');
    ...
    <script>
        $(document).ready(function(e) {
            $("#add_er").click(function(e) {
                ...
                form_data.append("assetid", assetid);

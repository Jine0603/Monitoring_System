                ...
                <div class="row page-titles mx-0">
                    <div class="col-sm-6 p-md-0">
                        <div class="welcome-text">
                            <h4>Asset Count Report</h4>
                            <span>Export All the Scan Asset</span>
                        </div>
                    </div>
                </div>
                <!-- row -->
                    ...
                    <div class="col-xl-13 col-lg-12">
                        <div class="card">
                            <div class="card-header">
                                <h4 class="card-title">FILTER FOR ASSET COUNT </h4>
                            </div>
                            <div class="card-body">

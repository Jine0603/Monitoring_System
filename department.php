                                    ...
                                    <form>
                                        <div class="form-row">
                                            <div class="form-group col-md-8">
                                                ...
                                                <label>Company</label>
                                                <select id="companyid" name="companyid" class="form-control default-select" placeholder="Select Companys" required>
                                        ...
                                        <button type="button" name="editBtn" id="editBtn" class="btn btn-primary">Edit</button>
                                    </form>
                                </div>
                            </div>
                        </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            $(document).on('click', '#submit', function(e) {
                ...
                if (companyid && departmentid && companyid != 'default') {

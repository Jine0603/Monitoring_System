                                    ...
                                    <form>
                                        <div class="form-row">
                                            <div class="form-group col-md-8">
                                                <label>Company</label>
                                                <input type="text" id="id" name="id" class="form-control" style="text-transform:uppercase" hidden>
                                                <select id="company" aria-placeholder="Select Company" name="company" class="form-control default-select" required>
                                        ...
                                        <div class="form-row">
                                            <div class="form-group col-md-8">
                                                ...
                                                <select id="departmentid" name="departmentid" class="form-control default-select" placeholder="sssssss" required>
    ...
    ***********************************-->
    ...
    <script>
        $(document).ready(function() {
            ...
            $(document).on('click', '#submit', function(e) {
                ...
                if (company && departmentid && position && company != 'default') {
    ...
    <script>
        $(document).on("click", ".edit", function() {
            ...
            $('#departmentid').html('<option value=' + depart + '>' + department + '</option>');

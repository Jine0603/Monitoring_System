...
$sql = "SELECT * FROM location_tbl WHERE status = 1";
...
while ($rows = mysqli_fetch_assoc($query)) {
    ...
    $act1 = '<button  class="btn btn-success add" data-id="' . $rows['id'] . '"
  title = "Add"><svg xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 640 512"><!--! Font Awesome Free 6.4.2 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license 

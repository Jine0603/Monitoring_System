...
$sql = "SELECT employee_tbl.id,com_tbl.company,dep_tbl.department,position_tbl.position As position, employee_tbl.employeeid,employee_tbl.firstname,
 employee_tbl.lastname,employee_tbl.email,employee_tbl.username,employee_tbl.password,employee_tbl.companyid,employee_tbl.departmentid,employee_tbl.positionid,employee_tbl.status,employee_tbl.datecreated
 FROM employee_tbl
...
WHERE employee_tbl.companyid               = 1 AND employee_tbl.status = 1 AND employee_tbl.employeeid";

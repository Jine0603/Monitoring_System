...
$pdf->Text(55.5, 61.5, 'DATE PURCHASE');
$pdf->SetFont('helvetica', 'B', 7);
$pdf->Text(56.5, 65, $date_purchase);
...
$pdf->Text(55.5, 124, 'DATE PURCHASE');
$pdf->SetFont('helvetica', 'B', 7);
$pdf->Text(56.5, 128, $date_purchase);
